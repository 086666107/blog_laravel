              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('/Admin/AddProduct')}}"><i class="fa fa-plus" aria-hidden="true"></i> Add Product</a></li>
                      <li><a href="{{('/Admin/ProductView')}}"><i class="fa fa-eye" aria-hidden="true"></i> Product View</a></li>
                ...
                <ul class=" navbar-right">
                  <li class="nav-item dropdown open" style="padding-left: 15px;">
                    <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                      <img src="/Back-end/production/images/img.jpg" alt="">John Doe
                    </a>
