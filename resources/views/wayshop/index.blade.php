                            ...
                            <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                                ...
                                <div class="list-group-collapse sub-men">
                                    ...
                                    <div class="collapse show" id="sub-men1" data-parent="#list-group-men">
                                        <!-- @foreach ($val->categories as $key => $ca) @endforeach-->
                                        <div class="list-group">
                                         <a href="{{url('/category/'.$val->id)}}" class="list-group-item list-group-item-action active">{{$val->name}}</a>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                ...
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="{{asset('/upload/'.$pro->image)}}" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                        ...
                                                        <a class="cart" href="{{url('/products/'.$pro->id)}}">Detail page</a>
                                                    </div>
                                                </div>
                                                <div class="why-text">
                                                    <h4>{{$pro->name}}</h4>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <div class="blog-box">
                        <div class="blog-img">
                            <img class="img-fluid" src="/Fron-end/images/blog-img.jpg" alt="" />
                        </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <div class="blog-box">
                        <div class="blog-img">
                            <img class="img-fluid" src="/Fron-end/images/blog-img-01.jpg" alt="" />
                        </div>
                        <div class="blog-content">
                            <div class="title-blog">
                                <h3>Fusce in augue non nisi fringilla</h3>
                ...
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <div class="blog-box">
                        <div class="blog-img">
                            <img class="img-fluid" src="/Fron-end/images/blog-img-02.jpg" alt="" />
                        </div>
                        <div class="blog-content">
                            <div class="title-blog">
                                <h3>Fusce in augue non nisi fringilla</h3>
