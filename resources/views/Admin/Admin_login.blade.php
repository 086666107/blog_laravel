...
<html lang="en">
  <head>
    ...
    <!-- Animate.css -->
    <link href="Back-end/vendors/animate.css/animate.min.css" rel="stylesheet">
          ...
          <section class="login_content">
            <form action="{{url('/admin')}}" method="post"> {{csrf_field()}}
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Online Shop</h1>
        ...
        <div id="register" class="animate form registration_form">
          <section class="login_content">
            <form>
              ...
              <div>
                <input type="password" class="form-control" placeholder="Cornfirm Password" required="" name="password" />
              </div>
              <div>
